...
function useContainerSize(ref) {
    ...
    useEffect(() => {
        ...
        const measure = () => {
            ...
            rafRef.current = requestAnimationFrame(() => setSize(el.offsetWidth));
        };
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 pointer-events-none" aria-hidden>
                {/* Full star field across the entire footer */}
                <StarLayer stars={SHARED_STARS} animName="ft-twinkle" />

                {/* Ambient blobs — distributed across top, middle, and bottom */}
                <div className="absolute top-1/4 -left-48 w-[560px] h-[560px] rounded-full blur-[150px]"
                    style={{ background: `rgba(${BRAND_RGB},0.07)` }} />
                <div className="absolute top-1/2 -right-40 w-[420px] h-[420px] rounded-full blur-[120px]"
                    style={{ background: `rgba(${BRAND_RGB},0.05)` }} />
                <div className="absolute bottom-1/3 right-0 w-[400px] h-[400px] rounded-full blur-[130px] translate-x-1/3"
                    style={{ background: `rgba(${BRAND_RGB},0.06)` }} />
                <div className="absolute bottom-0 left-0 w-[340px] h-[340px] rounded-full blur-[110px] translate-y-1/3 -translate-x-1/4"
                    style={{ background: `rgba(${BRAND_RGB},0.05)` }} />
            </div>

            {/* ── All content shares one z-10 layer ── */}
            <div className="relative z-10 w-full">
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-16 sm:pt-24 pb-16 sm:pb-20">
                    ...
                    >
                        ...
                        <h2 className="text-3xl sm:text-4xl font-bold text-white leading-tight tracking-tight">
                            Find Your{' '}
                            <span style={{ color: BRAND }}>Way Home</span>
                        </h2>
                    ...
                    <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-center">
                        ...
                        >
                            <div className="ft-float relative w-full">
                                <div aria-hidden className="absolute inset-[8%] rounded-full blur-[90px] pointer-events-none"
                                    style={{ background: `rgba(${BRAND_RGB},0.13)` }} />
                                <LiveGlobe />
                            </div>
                            <div aria-hidden className="w-3/5 h-5 rounded-full blur-2xl -mt-3 pointer-events-none"
                        ...
                        <div className="space-y-3 sm:space-y-4">
                            ...
                            >
                                ...
                                >
                                    <Navigation size={16} className="group-hover:rotate-12 transition-transform duration-300" aria-hidden />
                                    Get Directions
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                                ...
                                {QUICK_LINKS.map(link => (
                                    <li key={link.name}>
                                        {link.isHash ? (
                                            ...
                                            <Link to={link.href} className="group inline-flex items-center gap-2 text-sm text-white/38 hover:text-white transition-all duration-300">
                                                <ChevronRight size={12} className="group-hover:translate-x-1 transition-transform duration-300" style={{ color: BRAND }} />
                                                <span className="group-hover:translate-x-0.5 transition-transform duration-300">{link.name}</span>
                                            </Link>
                                        )}
                    ...
                    {/* Copyright */}
                    <div className="py-6" style={{ borderTop: `1px solid rgba(${BRAND_RGB},0.07)` }}>
