                    ...
                    <div className="flex lg:hidden items-center justify-between h-20">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            {isAuthenticated && (
                                <div className="relative" ref={mobileUserDropdownRef}>
                                    <motion.button
                                        ...
                                        className="h-10 flex items-center gap-2 px-2 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 transition-colors duration-200"
                                    >
                                        <Avatar size="xs" name={user?.initials} src={user?.avatar} />
                                        <motion.div
                            ...
                            <motion.button
                                ...
                                className="h-10 w-10 flex items-center justify-center bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 transition-colors duration-200"
                            >
